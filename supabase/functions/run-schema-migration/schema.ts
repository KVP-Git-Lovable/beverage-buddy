...
-- (skipped C-language extension function)
...
ALTER TABLE public.workflow_steps ADD CONSTRAINT workflow_steps_workflow_id_fkey FOREIGN KEY (workflow_id) REFERENCES approval_workflows(id) ON DELETE CASCADE;-- INDEXES (non-constraint)
-- ============================================================
