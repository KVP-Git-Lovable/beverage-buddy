DROP FUNCTION IF EXISTS public.execute_stock_action(UUID, UUID, TEXT, INTEGER, TEXT, UUID, TEXT, DATE, UUID, TEXT, UUID);
DROP FUNCTION IF EXISTS public.execute_stock_action(UUID, UUID, TEXT, INTEGER, TEXT, UUID, TEXT, TEXT, UUID, TEXT, UUID);
...
DROP FUNCTION IF EXISTS public.check_opening_stock_exists(UUID, UUID);
DROP FUNCTION IF EXISTS public.check_opening_stock_exists(UUID, UUID, UUID);
