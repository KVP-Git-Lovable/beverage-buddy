...
import { Users, Package, ArrowLeft, CalendarDays, MapPin, DollarSign, BarChart3, MessageSquareText, Navigation, Store, Truck, Flag, Trophy, FileText, CreditCard, Lock, Bell, Trash2, Building2, Gift, Target, Map, Percent, Database, Ruler } from 'lucide-react';
...
const AdminControls = () => {
  ...
  const adminModules = [
    ...
    { title: "Unit of Measure Master", description: "Manage measurement units, defaults, and ordering for product catalog", icon: Ruler, color: "sky", path: "/admin/uom-master" },
