...
import CounterSaleWizardLayout from "./pages/counter-sale/CounterSaleWizardLayout";
import CustomerSelectionPage from "./pages/counter-sale/CustomerSelectionPage";
import CreateCustomerPage from "./pages/counter-sale/CreateCustomerPage";
import WalkinDetailsPage from "./pages/counter-sale/WalkinDetailsPage";
import AddProductsPage from "./pages/counter-sale/AddProductsPage";
import ReviewPage from "./pages/counter-sale/ReviewPage";
...
import RetailerListsPage from "./pages/admin/RetailerListsPage";
...
<Route path="/territories-and-distributors" element={<ProtectedRoute><TerritoriesAndDistributors /></ProtectedRoute>} />
        ...
        {/* Counter Sale wizard (multi-page POS flow inside Activity module) */}
        <Route
          path="/counter-sale/new"
          element={
            <ProtectedRoute>
              <CounterSaleWizardLayout />
            </ProtectedRoute>
          }
        >
          <Route index element={<Navigate to="customer" replace />} />
          <Route path="customer" element={<CustomerSelectionPage />} />
          <Route path="customer/new" element={<CreateCustomerPage />} />
          <Route path="walkin" element={<WalkinDetailsPage />} />
        ...
        <Route path="/visits/event/:eventId" element={<ProtectedRoute><EventDetail /></ProtectedRoute>} />
        <Route path="/visits/event/:eventId/summary" element={<ProtectedRoute><EventSummary /></ProtectedRoute>} />
        ...
        <Route path="/admin/retailer-lists" element={<ProtectedRoute><RetailerListsPage /></ProtectedRoute>} />
        ...
        {/* DMS Layout with persistent sidebar — guarded by DistributorProtectedRoute */}
        <Route path="/distributor-portal" element={<DistributorProtectedRoute><DMSLayout /></DistributorProtectedRoute>}>
        ...
        <Route path="/customer-portal" element={<CustomerLayout />}>
          <Route path="home" element={<CustomerCatalog />} />
          <Route path="schemes" element={<CustomerSchemes />} />
          <Route path="catalog" element={<CustomerHome />} />
